...
const SearchData = async (isSearch) => {
    ...
    tableCell.textContent = "PontszaSm";
...
/*
-Lehessen megváltoztatni a rendezési szempontot (alapértelmezetten név szerint volt).
-Lehessen a különféle pontértékek alapján is rendezni! Tipp: A táblázat fejlécében a mező nevére kattintva történjen a rendezés.
*/
